...
const SafePrivacyPolicy = () => (
  <SmoothScroll>
    ...
    <ol>
      ...
      <li>
        &ldquo;{'Zilliqa Safe'}&rdquo; refers to a web-based graphical user interface for Safe Accounts as well as a
    ...
    <h4>4.1. When visiting our website and using {'Zilliqa Safe'}</h4>
    <p>
      When visiting our website or using {'Zilliqa Safe'}, we may collect and process personal data. The data will be
    ...
    <ol start={4}>
      <li>
        ...
        the {'Zilliqa Safe'}, we process your
        <ol>
    ...
    <p>
      In addition, we may take a recording of you while testing {'Zilliqa Safe'} for internal and external use. The
    ...
    <p>
      {'Zilliqa Safe'} mobile apps are distributed via{' '}
    ...
    <p>
      We enable the user to unlock the {'Zilliqa Safe'} mobile app via biometrics information (touch ID or face ID).
    ...
    <p>
      ...
      different decentralized applications and our app and to enhance your experience with {`Zilliqa Safe`}. For
...
const PrivacyPolicy: NextPage = () => {
  return (
    <>
      <Head>
        <title>{'Zilliqa Safe – Privacy policy'}</title>
      </Head>
